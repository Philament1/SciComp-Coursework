...
The problem the functions attempt to solve is to find a path in a graph from a source node to a target node in such a way that the path minimises the maximum edge weight along the path. 
