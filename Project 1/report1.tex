...
The strategy \textit{part1} uses a hybrid sorting algorithm, where initially the elements of the list are sorted using an insertion sort, up to the index \textit{istar}. Then, a binary search is used to determine where to insert the following elements with an index greater than \textit{istar}. 
