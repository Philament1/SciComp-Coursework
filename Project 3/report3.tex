...
To determine the accuracy, cost and efficiency of both methods, we apply them to each function and plot the errors as the absolute difference between the interpolated value and the actual value. We also measure the average wall times (over 1000 runs) and calculate the RMSE (Root Mean Square Error). 
