...
We observe from Figure \ref{fig_contour} the sinusoidal oscillations with $c=0.5$ which are at a higher frequency with $c=1.2$, but the oscillations in the system appear to be more chaotic with $c=1.3$ and chaotic at a higher frequency with $c=1.5$.
